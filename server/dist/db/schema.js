// Supabase veritabanı şeması - SQL migration
// Bu dosyayı Supabase SQL editöründe çalıştırın
export const schema = `
-- Kullanıcılar (Supabase Auth ile otomatik)
-- auth.users tablosu zaten var, users tablosunu trigger ile senkronize ediyoruz
...
-- Dinleme geçmişi (otomatik listeler için)
